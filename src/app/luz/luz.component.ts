...
export class LuzComponent {
  ...
  ngOnInit(): void {
    let tiempos: string[] = [];
    const realtimeRef = this.db.list('/HydroGrow/LUMINOSIDAD ');
        ...
        datasets: [
          {
            ...
            label: "Intensidad de luz actual",
            backgroundColor: ['rgb(1,140,47)'],
        ...
        datasets: [ 
          {
            ...
            label: "Datos históricos de intensidad de luz",
